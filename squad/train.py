...
def main(args):
    ...
    for ex in train_data:
        ...
        count+=1
        print(count)
        question, passage, answer = ex["question"], ex["context"], ex["answers"]["text"][0]
        ...
        question_combo = question + " [SEP] " + answer
        question_encodings_dict = tokenizer(question_combo, truncation=True, max_length=MAXLEN_question, padding="max_length")
